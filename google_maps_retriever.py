...
# code from here: https://stackoverflow.com/questions/7490491/capture-embedded-google-map-image-with-python-without-using-a-browser/50536888#50536888
...
api_key = open("/Users/alexsisu/ec2keys/google_api.key").read().strip()
...
if __name__ == '__main__':
  ...
  im2arr = np.array(result)
  outputimg = Image.fromarray(im2arr)
  outputimg.save("final.jpg")
  outputimg.save("final.tif")
#  result.show()